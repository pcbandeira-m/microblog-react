...
Criar um sistema de microblog considerando a possilidade de autenticação de usuário por login, publicação de postagens, visualização do conteúdo de outros autores e comentários nessas publicações.

## Objetivo

A principal finalidade desse projeto é praticar o que foi aprendido no treinamento para desenvolvedores juniores da PNP no IFRN/CNAT.
